	...
	<div class="container container-center">
		...
		<p data-margin>
			...
			<button class="button button-success" type="button">Button</button>
		...
		<p data-margin>
			...
			<button class="button button-link" type="button">Button</button>
		...
		<p data-margin>
			...
			<button class="button button-success button-mini" type="reset">Button</button>
		...
		<p data-margin>
			...
			<button class="button button-success button-small" type="reset">Button</button>
		...
		<p data-margin>
			...
			<button class="button button-success button-large" type="reset">Button</button>
		...
		<p>
			...
			<button class="button button-success col-1-12 margin-bottom" type="reset">Button</button>
		...
		<p data-margin>
			...
			<button class="button button-primary button-mini" type="reset">
				<i class="icon-cog"></i> Button
				<i class="icon-cog"></i>
			</button>
			<button class="button button-success button-mini" type="reset">
				<i class="icon-cog"></i> Button
				<i class="icon-cog"></i>
			</button>
			<button class="button button-danger button-mini" type="reset">
				<i class="icon-cog"></i> Button
				<i class="icon-cog"></i>
			</button>
			<button class="button button-mini" disabled>
				<i class="icon-cog"></i> Disabled
				<i class="icon-cog"></i>
			</button>
		</p>
		<p data-margin>
			...
			<button class="button button-primary button-small" type="reset">
				<i class="icon-cog"></i> Button
				<i class="icon-cog"></i>
			</button>
			<button class="button button-success button-small" type="reset">
				<i class="icon-cog"></i> Button
				<i class="icon-cog"></i>
			</button>
			<button class="button button-danger button-small" type="reset">
				<i class="icon-cog"></i> Button
				<i class="icon-cog"></i>
			</button>
		...
		<p data-margin>
			...
			<button class="button button-primary" type="reset">
				<i class="icon-cog"></i> Button
				<i class="icon-cog"></i>
			</button>
			<button class="button button-success" type="reset">
				<i class="icon-cog"></i> Button
				<i class="icon-cog"></i>
			</button>
			<button class="button button-danger" type="reset">
				<i class="icon-cog"></i> Button
				<i class="icon-cog"></i>
			</button>
		...
		<p data-margin>
			...
			<button class="button button-primary button-large" type="reset">
				<i class="icon-cog"></i> Button
				<i class="icon-cog"></i>
			</button>
			<button class="button button-success button-large" type="reset">
				<i class="icon-cog"></i> Button
				<i class="icon-cog"></i>
			</button>
			<button class="button button-danger button-large" type="reset">
				<i class="icon-cog"></i> Button
				<i class="icon-cog"></i>
			</button>
