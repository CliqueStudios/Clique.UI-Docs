	...
	<div class="container container-center">
		...
		<p>
			<button class="button" data-toggle="{target:'#toggle1'}">Toggle</button> <a href="#" data-toggle="{target:'#toggle1'}">Link</a></p>
		...
		<p>
			<button class="button" data-toggle="{target:'.toggle2'}">Toggle</button>
		</p>
		...
		<p>
			<button class="button" data-toggle="{target:'#toggle4', cls:'panel-box-primary'}">Toggle</button>
		</p>
		...
		<p>
			<button class="button" data-toggle="{target:'#toggle5', animation:'animation-fade'}">Toggle</button>
		</p>

		<div id="toggle5" class="panel panel-box">Animation...</div>

		<p>
			<button class="button" data-toggle="{target:'#toggle6', animation:'animation-slide-left, animation-slide-top'}">Toggle</button>
		</p>
