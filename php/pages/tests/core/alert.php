	...
	<div class="container container-center">
		...
		<div class="alert alert-large alert-success" data-alert>
			<button type="button" class="alert-close close"></button>
			<h2>Today's headline</h2>
		...
		<div class="alert alert-large alert-warning" data-alert>
			<button type="button" class="alert-close close"></button>
			<h2>Today's headline</h2>
		...
		<div class="alert alert-large alert-danger" data-alert>
			<button type="button" class="alert-close close"></button>
			<h2>Today's headline</h2>
