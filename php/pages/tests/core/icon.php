	...
	<div class="container container-center">
		...
		<h2>
			<i class="icon-cog"></i> An H2 element with icon</h2>
		<h3>
			<i class="icon-cog"></i> An H3 element with icon</h3>
		<h4>
			<i class="icon-cog"></i> An H4 element with icon</h4>
		<h5>
		...
		<div class="row" data-row-margin>
			<div class="col-2-10-medium">
				<ul class="list">
					<li>
						<i class="icon-cog"></i> li element</li>
					<li>
						<a href="#">
							<i class="icon-cog"></i> a element</a>
					</li>
					<li>
						<em>
							<i class="icon-cog"></i> em element</em>
					</li>
					<li>
						<strong>
							<i class="icon-cog"></i> strong element</strong>
					</li>
					<li><code><i class="icon-cog"></i> code element</code></li>
					<li>
						<del>
							<i class="icon-cog"></i> del element</del>
					</li>
				</ul>
			</div>
			<div class="col-2-10-medium">
				<ul class="list">
					<li>
						<ins>
							<i class="icon-cog"></i> ins element</ins>
					</li>
					<li>
						<mark>
							<i class="icon-cog"></i> mark element</mark>
					</li>
					<li>
						<q>
							<i class="icon-cog"></i> q element</q>
					</li>
					<li>
						<abbr title="Abbreviation Element">
							<i class="icon-cog"></i> abbr element</abbr>
					</li>
					<li>
						<dfn title="Defines a definition term">
							<i class="icon-cog"></i> dfn element</dfn>
					</li>
					<li>
						<small>
							<i class="icon-cog"></i> small element</small>
					</li>
				</ul>
			</div>
			<div class="col-2-10-medium">
				<ul class="list list-line">
					<li>
						<i class="icon-cog"></i> List item 1</li>
					<li>
						<i class="icon-cog"></i> List item 2</li>
					<li>
						<i class="icon-cog"></i> List item 3</li>
					<li>
			...
			<div class="col-2-10-medium">
				<table class="table table-striped table-hover">
					<caption>
						<i class="icon-cog"></i> Table caption</caption>
					<thead>
						<tr>
							<th>
								<i class="icon-cog"></i> Table Heading</th>
						</tr>
					</thead>
					<tfoot>
						<tr>
							<td>
								<i class="icon-cog"></i> Table Footer</td>
						</tr>
					</tfoot>
					<tbody>
						<tr>
							<td>
								<i class="icon-cog"></i> Table Data</td>
						</tr>
					</tbody>
				</table>
			</div>
		...
		<ul class="list list-space">
			...
			<li>
				<i class="icon-cog icon-small"></i> Modifier icon-small</li>
			<li>
				<i class="icon-cog icon-medium"></i> Modifier icon-medium</li>
			<li>
