...
<div class="container container-center">
	<h1>Off Canvas</h1>
	<p>
		<a href="#offcanvas-1" data-offcanvas>Left</a>
		<button class="button" data-offcanvas="{target:'#offcanvas-2'}">Right</button>
	</p>
	...
	<div id="offcanvas-1" class="offcanvas">
		<div class="offcanvas-bar">
			<ul class="nav nav-offcanvas nav-parent-icon" data-nav>
				...
				<li><a href="#"><i class="icon-star"></i> Item</a></li>
