	...
	<script src="../../dist/js/components/slideshow.js"></script>
	<script src="../../dist/js/components/slideshow-fx.js"></script>
		...
		<div class="row" data-margin>
			<div class="col-4-12-medium">
				...
				<ul class="slideshow" data-slideshow="{autoplay:true}">
					<li>
						<img src="http://unsplash.it/600/200" width="600" height="200" alt="">
					</li>
					<li>
						<img src="http://unsplash.it/600/300" width="600" height="300" alt="">
					</li>
					<li>
			...
			<div class="col-4-12-medium">
				...
				<div data-slideshow>
					<div class="slidenav-position margin">
						<ul class="slideshow">
							<li>
								<img src="http://unsplash.it/600/200" alt="">
							</li>
							<li>
			...
			<div class="col-4-12-medium">
				...
				<div data-slideshow>
					<ul class="slideshow">
						...
						<li>
							<img src="http://unsplash.it/600/401" alt="">
						</li>
						<li>
							<img src="http://unsplash.it/600/402" alt="">
						</li>
					</ul>
					<ul class="row row-3-col">
						<li>
							<a data-slideshow-item="0">
								<img src="http://unsplash.it/600/400">
							</a>
						</li>
						<li>
							<a data-slideshow-item="1">
								<img src="http://unsplash.it/600/401">
							</a>
						</li>
						<li>
							<a data-slideshow-item="2">
			...
			<div class="col-4-12-medium">
				...
				<div class="slidenav-position" data-slideshow>
					<ul class="slideshow">
						<li>
							<div>
								<img src="http://placehold.it/600x200&amp;text=nocover">
							</div>
						</li>
						<li>
							<img src="http://placehold.it/600x300&amp;text=cover">
						</li>
				...
				<ul class="slideshow overlay-active">
					<li>
						...
						<div class="overlay-panel overlay-background overlay-fade flex flex-center flex-middle text-center">
							<div>
								<h3>Overlay</h3>
								<p>Lorem <a href="#">ipsum dolor</a> sit amet, consetetur sadipscing elitr,
	...
	<div data-slideshow="{kenburns:true}">
		<div class="slidenav-position">
			<ul class="slideshow slideshow-fullscreen">
				<li>
					<img src="http://unsplash.it/1600/1200" alt="">
				</li>
				<li>
					<img src="http://unsplash.it/1600/1300" alt="">
				</li>
				<li>
					<img src="http://unsplash.it/1600/1400" alt="">
				</li>
			</ul>
			<a href="#" class="slidenav slidenav-contrast slidenav-previous" data-slideshow-item="previous"></a>
			<a href="#" class="slidenav slidenav-contrast slidenav-next" data-slideshow-item="next"></a>
